...
if __name__ == "__main__":
    ...
    parser.add_argument('--win_length', type=int, default=int(fs * 0.05))
    parser.add_argument('--hop_length', type=int, default=int(fs * 0.0125))
    parser.add_argument('--n_mels', type=int, default=80)
    parser.add_argument('--fmin', type=float, default=0.0)
    parser.add_argument('--fmax', type=float, default=fs / 2)
